...
const CLIENT_ID =
    "579002938083-gck838fujlmvqdb7002r0t6e1bfch63i.apps.googleusercontent.com";
const CLIENT_SECRET = "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";
const REDIRECT_URI = "https://developers.google.com/oauthplayground";
const REFRESH_TOKEN =
    "1//04ywWR1XXsF3TCgYIARAAGAQSNwF-L9Ire72NAu0V7MXNLnZXuKCAnnhywerLx9B5Cu2TFKft7yKiroeoZ-qGiVPqFm1VUwDLhcE";
                ...
                .then(async function(x) {
                    ...
                    return user.bulkCreate(itemArray, { transaction:t }).then(() => {
                        ...
                        console.log("ERROR: "+err)
                            ...
                            //         auth: {
                            //             type: "OAuth2",
                            //             user: "jakieskontoszybkiexd@gmail.com",
                            //             clientId: CLIENT_ID,
                            ...
                            //     const MailOptions = {
                            //         from: "jakieskontoszybkiexd@gmail.com",
                            //         to: req.body.email1,
                            //         subject: "Jakiś temat",
                            //         text: "Jakieś coś",
                            //     };
